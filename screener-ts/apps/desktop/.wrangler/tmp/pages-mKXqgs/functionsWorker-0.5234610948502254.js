...
var onRequestGet = /* @__PURE__ */ __name(async (ctx) => {
  ...
  params.set("token", ctx.env.FINNHUB_API_KEY);
...
async function getAuth() {
  ...
  for (const src of ["https://fc.yahoo.com", "https://finance.yahoo.com"]) {
    try {
      ...
      const set = c.headers.getSetCookie?.() ?? [];
...
var onRequestGet4 = /* @__PURE__ */ __name(async (ctx) => {
  ...
  const call = /* @__PURE__ */ __name(async (auth) => {
...
// ../.wrangler/tmp/pages-mKXqgs/functionsRoutes-0.7608741604380073.mjs
var routes = [
  {
