...
const STRINGS: Record<string, { en: string; vi: string }> = {
  ...
  'picks.vol.period': { en: 'Compare period', vi: 'Kỳ so sánh' },
  ...
  'picks.vol.recent': { en: 'Recent Avg Vol', vi: 'KL trung bình gần đây' },
  ...
  'pf.clearcache': { en: 'Clear cache', vi: 'Xóa bộ nhớ đệm' },
